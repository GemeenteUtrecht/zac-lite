...
os.environ.setdefault(
    "SECRET_KEY", "hfz%gy_6@%$1p2bl$fkiz76)_depel)fve@a8ely0x8s$wfesa"
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "zac_lite"),
os.environ.setdefault("DB_USER", "zac_lite"),
os.environ.setdefault("DB_PASSWORD", "zac_lite"),
